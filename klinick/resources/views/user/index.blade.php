...
@section('content')
	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col">
				<h2 class="generalThemeColorUsers">@php
		...
		<div class="row">
			...
			<div class="col menu-option-div">
				<button type="button" class=" menuOptionButton" data-toggle="modal" data-target="#tokenCreationForm">
					<div class="m-1">
			...
			<div class="col menu-option-div">
				<button type="button" class=" menuOptionButton" data-toggle="modal">
