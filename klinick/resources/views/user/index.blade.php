...
@section('content')
	...
	@include('templates.topMenuBar.render', [
		"userIsADoctor" => $user->isADoctor,
		"title" => 'Bem vindo <b>'.$user->name.'</b> <br>'
		]
	)
	...
	<!--<div class="main-page-title">
		@php
				echo 'Bem vindo <b>'.$user->name.'</b> <br>';
		@endphp
	</div>-->
	...
	<div class="container-fluid menu-container">
		<div class="row menu-area">
			<div class="col menu-option-div">
				<button type="button" class=" novo-background menuOptionButton" data-toggle="modal" data-target="#tokenCreationForm">
					<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="bi bi-calendar2-plus" viewBox="0 0 16 16">
						<path d="M3.5 0a.5.5 0 0 1 .5.5V1h8V.5a.5.5 0 0 1 1 0V1h1a2 2 0 0 1 2 2v11a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V3a2 2 0 0 1 2-2h1V.5a.5.5 0 0 1 .5-.5zM2 2a1 1 0 0 0-1 1v11a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1H2z"/>
						<path d="M2.5 4a.5.5 0 0 1 .5-.5h10a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-.5.5H3a.5.5 0 0 1-.5-.5V4zM8 8a.5.5 0 0 1 .5.5V10H10a.5.5 0 0 1 0 1H8.5v1.5a.5.5 0 0 1-1 0V11H6a.5.5 0 0 1 0-1h1.5V8.5A.5.5 0 0 1 8 8z"/>
					</svg>
					<span class="button-label">Novo Atendimento</span>
				</button>
			</div>
		</div>
		...
		<!--<div class="row menu-area">
			<div class="col menu-option-div">
				<button type="button" class="em-espera-background menuOptionButton" data-toggle="modal">
					...
					<span class="button-label">Atendimentos em espera</span>
				</button>
			</div>
		</div>-->
		...
		<div class="row menu-area">
			<div class="col menu-option-div">
				<button type="button" id="btnMedFormService" class=" em-andamento-background menuOptionButton" data-toggle="modal">
					...
					<span class="button-label">Fichas & Atendimentos</span>
				</button>
			</div>
		</div>
		...
		<!--<div class="row menu-area">
			<div class="col menu-option-div">
				<button type="button" class=" finalizadas-background menuOptionButton" data-toggle="modal">
	...
	<script>
		btnMedFormService = document.getElementById('btnMedFormService');

		btnMedFormService.addEventListener("click", function(){
			window.location.href = '/user/{{$user->id}}/medform';
		});
	</script>
