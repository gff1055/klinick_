...
<div class="mdl modal fade" id="modalExemplo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<div class="modal-dialog" role="document">
	  <div class="modal-content">
		...
		Mesmo o consultorio KLINICK,
		sendo um ambiente virtual, toda conduta ética e
		profissional deve ser respeitada.
	
		</div>
		<div class="modal-footer">
			<button type="button" class="btn colorTheme buttonOk">Ok, entendi</button>
		</div>
	  </div>
	</div>
  </div>
...
<section class="topMenuBar">
		...
		<div id="menuToggle">
			...
			<ul id="menu">
				...
				<a href="{{ route('user.index') }}"><li>
						...
						Home</li></a>
				<a href="#"><li><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-calendar2-check iconMenuToggle" viewBox="0 0 16 16">
				  ...
				  </svg> Agendar Consulta</li></a>
				<a href="{{ route('user.index') }}"><li> <!-- user temporario aqui é doctor -->
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-person-badge-fill iconMenuToggle" viewBox="0 0 16 16">
						...
						Area de médicos</li></a>
				<a href="#"><li>
						<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-clipboard-data iconMenuToggle" viewBox="0 0 16 16">
							<path fill-rule="evenodd" d="M4 1.5H3a2 2 0 0 0-2 2V14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V3.5a2 2 0 0 0-2-2h-1v1h1a1 1 0 0 1 1 1V14a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3.5a1 1 0 0 1 1-1h1v-1z"/>
							<path fill-rule="evenodd" d="M9.5 1h-3a.5.5 0 0 0-.5.5v1a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 .5-.5v-1a.5.5 0 0 0-.5-.5zm-3-1A1.5 1.5 0 0 0 5 1.5v1A1.5 1.5 0 0 0 6.5 4h3A1.5 1.5 0 0 0 11 2.5v-1A1.5 1.5 0 0 0 9.5 0h-3z"/>
							<path d="M4 11a1 1 0 1 1 2 0v1a1 1 0 1 1-2 0v-1zm6-4a1 1 0 1 1 2 0v5a1 1 0 1 1-2 0V7zM7 9a1 1 0 0 1 2 0v3a1 1 0 1 1-2 0V9z"/>
						  </svg> Histórico Médico</li></a>
				<a href="{{ route('user.settingsPersonalData') }}"><li>
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-gear iconMenuToggle" viewBox="0 0 16 16">
					...
					Configurações</li></a>
				<a href="{{ route('user.logout') }}" class="buttonExitUser"><li>
					<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-box-arrow-left iconMenuToggle" viewBox="0 0 16 16">
	...
	<!--<div class="itemTopMenuBar_logo col-1">
		<a href=""><span class="logo">KlinicK</span></a>
	</div>-->
